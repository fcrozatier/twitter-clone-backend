...
from api.relay.id_types import BaseGlobalIDType, DefaultGlobalIDType
from graphene.types import Field, Interface, ObjectType
...
class AbstractNode(Interface):
    ...
    def __init_subclass_with_meta__(cls, global_id_type=DefaultGlobalIDType, **options):
        ...
        _meta.fields = {"global_id": GlobalID(cls, global_id_type=global_id_type, description="The ID of the object")}
